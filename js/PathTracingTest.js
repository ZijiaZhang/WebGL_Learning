...
var Initialize = function () {
  ...
  var tick = function(time){
    ...
    var projection = makePerspective(55, canvas.width/canvas.height, 0.1, 100);
  ...
  setInterval(function () {
    tick((new Date() - start)/1000);},1000/60
  );
